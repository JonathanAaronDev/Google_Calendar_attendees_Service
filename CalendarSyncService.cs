...
namespace Google_Calendar_Service
{
    public class CalendarSyncService
    {
        ...
        public CalendarSyncService() : this(new SqlCalendarRepository(), new GoogleCalendarClient())
        {
        }

        public CalendarSyncService(ICalendarRepository repository, IGoogleCalendarClient googleClient)
        {
